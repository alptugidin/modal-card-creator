...
<svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	<div><img style="border-top-left-radius: .75rem;border-top-right-radius: .75rem" src="${window.userData.img.length > 1 ? window.userData.img : 'http://localhost:3000/Modal26/img.png'}" width="480" height="250" alt="" /></div>
