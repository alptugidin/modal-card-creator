...
<div id="MODAL${window.userData.id}" class="Modal9_body__PB4VG" style="--bgColor:${window.userData.color.background};
...
<svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	<div><img style="border-top-right-radius: .75rem; border-top-left-radius: .75rem" width="480" height="334" src="${window.userData.img.length > 1 ? window.userData.img : 'https://modal-card-creator-eight.vercel.app/Modal9/img.png'}" alt=""/></div>
	<div class="Modal9_textDiv__FJriA">
		<p>${window.userData.content[0]}</p>
		<p>${window.userData.content[1]}</p>
	</div>
	<div class="Modal9_inputDiv__PuCri">
		<input type="text" placeholder="${window.userData.content[2]}" />
		<input type="text" placeholder="${window.userData.content[3]}" />
	</div>
	<div class="Modal9_signDiv__Ugmxc">
		<button type="button">${window.userData.content[4]}</button>
	</div>
	<div class="Modal9_accountText__AunfK">
...
.Modal9_textDiv__FJriA {
	//margin-top: 1.25rem;
	text-align: center;
	color: var(--textColor);
}

.Modal9_textDiv__FJriA :first-child {
	font-size: 1.875rem;
	line-height: 2.25rem;
	font-weight: 600;
	margin:0;
...
.Modal9_textDiv__FJriA :last-child {
	margin-top: 1.25rem;
	font-size: 1.25rem;
	line-height: 1.75rem;
}

.Modal9_inputDiv__PuCri {
	margin-top: 1.25rem;
	display: flex;
	//width: 100%;
	flex-direction: column;
...
.Modal9_inputDiv__PuCri :first-child,.Modal9_inputDiv__PuCri :last-child {
	height: 3rem;
	width: 100%;
	gap: 1.25rem;
	border-radius: .5rem;
...
.Modal9_inputDiv__PuCri :first-child::-moz-placeholder,.Modal9_inputDiv__PuCri :last-child::-moz-placeholder {
	--tw-placeholder-opacity: 1;
	color: rgb(75 85 99/var(--tw-placeholder-opacity));
}

.Modal9_inputDiv__PuCri :first-child::placeholder,.Modal9_inputDiv__PuCri :last-child::placeholder {
	--tw-placeholder-opacity: 1;
	color: rgb(75 85 99/var(--tw-placeholder-opacity));
}
...
.Modal9_signDiv__Ugmxc :first-child {
	margin-top: 1.25rem;
	height: 3rem;
	width: 83%;
	border-radius: .5rem;
...
.Modal9_accountText__AunfK span {
	text-decoration-line: underline;
}

.Modal9_cancel__8HSxs {
	position: absolute;
	top: .75rem;
	right: .75rem;
	border-width: 0;
