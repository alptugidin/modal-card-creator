...
<div id="MODAL${window.userData.id}" class="Modal8_body__temff" style="--bgColor:${window.userData.color.background};
...
<svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	<div class="Modal8_textDiv__r3XpL">
		<p>${window.userData.content[0]}</p>
		<p>${window.userData.content[1]}</p>
	</div>
	<div class="Modal8_inputDiv__7KSCB">
		<input type="text" placeholder="${window.userData.content[2]}" />
	</div>
	<div class="Modal8_btnDiv__BtHny">
		<button type="button" class="Modal8_toggleButton__qQajs">
			<div class="Modal8_active__g4rUA"></div>
		</button>
		<p>${window.userData.content[3]}</p>
	</div>
	<div class="Modal8_signDiv__IK9Jj">
...
.Modal8_textDiv__r3XpL {
	margin-top: 1.25rem;
	text-align: center;
	color: var(--bgColor);
}

.Modal8_textDiv__r3XpL :first-child {
	font-size: 1.875rem;
	line-height: 2.25rem;
	font-weight: 600;
}

.Modal8_textDiv__r3XpL :last-child {
	margin-top: 1.25rem;
	font-size: 1.25rem;
	line-height: 1.75rem;
}

.Modal8_inputDiv__7KSCB {
	margin-left: auto;
	margin-right: auto;
	margin-top: 2.5rem;
	display: flex;
...
.Modal8_inputDiv__7KSCB :first-child {
	height: 3rem;
	width: 100%;
	border-radius: .5rem;
	border-width: 1px;
...
.Modal8_inputDiv__7KSCB :first-child::-moz-placeholder {
	--tw-placeholder-opacity: 1;
	color: rgb(75 85 99/var(--tw-placeholder-opacity));
}

.Modal8_inputDiv__7KSCB :first-child::placeholder {
	--tw-placeholder-opacity: 1;
	color: rgb(75 85 99/var(--tw-placeholder-opacity));
}
...
.Modal8_btnDiv__BtHny :nth-child(2) {
	font-size: 13px;
	color: var(--bgColor);
}

.Modal8_toggleButton__qQajs {
	height: 23px;
	width: 23px;
...
.Modal8_signDiv__IK9Jj :first-child {
	margin-top: 1.25rem;
	height: 3rem;
	width: 50%;
	border-radius: .5rem;
