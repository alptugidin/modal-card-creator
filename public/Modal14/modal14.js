...
<div  id="MODAL${window.userData.id}" class="Modal14_body__VGwsw" style="--bgColor:${window.userData.color.background};
...
transform:scale(${scale()});transform-origin:${origin()}">
	...
	<div class="Modal14_ppDiv__arCiV"><img src="http://localhost:3000/Modal14/img.png" alt="" /></div>
...
<svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	<div class="Modal14_mainDiv__1RiJi">
		<div class="Modal14_infoDiv__8e6o9">
			<p>${window.userData.content[0]}</p>
			<p>${window.userData.content[1]}</p>
		</div>
		<div class="Modal14_textDiv__eST8V">
...
.Modal14_ppDiv__arCiV {
	display: flex;
	justify-content: center;
	padding-right: 1.25rem;
}

.Modal14_ppDiv__arCiV :first-child {
	height: 100px;
	width: 100px;
}

.Modal14_mainDiv__1RiJi {
	flex-basis: 75%;
}

.Modal14_infoDiv__8e6o9 {
	display: flex;
	height: 100px;
...
.Modal14_infoDiv__8e6o9 :first-child {
	font-size: 1.5rem;
	line-height: 2rem;
	font-weight: 600;
	color: var(--textColor);
...
.Modal14_infoDiv__8e6o9 :nth-child(2) {
	color: var(--otherTextColor);
}

.Modal14_textDiv__eST8V {
	margin-top: 1.25rem;
}

.Modal14_textDiv__eST8V :first-child {
	color: var(--textColor);
}

.Modal14_textDiv__eST8V :nth-child(2) {
	margin-top: 2.5rem;
	font-size: .875rem;
	line-height: 1.25rem;
	color: var(--otherTextColor);
