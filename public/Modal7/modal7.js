...
<div  id="MODAL${window.userData.id}" class="Modal7_body__NqRDx"
...
<svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	<div class="Modal7_textDiv__XFYEp">
		<p>${window.userData.content[0]}</p>
		<p>${window.userData.content[1]}</p>
	</div>
	<div class="Modal7_btnDiv__3vr44">
...
.Modal7_textDiv__XFYEp {
	margin-top: 1.25rem;
	text-align: center;
	color: var(--bgColor);
}

.Modal7_textDiv__XFYEp :first-child {
	font-size: 1.875rem;
	line-height: 2.25rem;
	font-weight: 600;
}

.Modal7_textDiv__XFYEp :last-child {
	margin-top: 1.25rem;
	font-size: 1.25rem;
	line-height: 1.75rem;
}

.Modal7_btnDiv__3vr44 {
	margin-top: 2.5rem;
	display: flex;
	width: 100%;
	align-items: center;
...
.Modal7_btnDiv__3vr44 :first-child,.Modal7_btnDiv__3vr44 :last-child {
	height: 3rem;
	width: 100%;
	border-radius: .5rem;
	border-width: 1px;
...
.Modal7_btnDiv__3vr44 :first-child {
	--tw-text-opacity: 1;
	color: rgb(255 255 255/var(--tw-text-opacity));
}

.Modal7_btnDiv__3vr44 :last-child {
	border-width: 0;
	background-color: var(--bgColor);
}

.Modal7_cancel___0pWM {
	position: absolute;
	top: .75rem;
	right: .75rem;
	border-width: 0;
