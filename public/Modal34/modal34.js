...
<div id="MODAL${window.userData.id}" class="Modal34_body__E4EBo" style="--bgColor:${window.userData.color.background};
...
<svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	<div><img width="740" height="400" src="https://modal-card-creator-eight.vercel.app/Modal34/img.png" alt="img" class="object-cover" /></div>
	<div class="Modal34_leftDiv__1mAaA" style="--textColor:#000000">
		<p>${window.userData.content[0]}</p>
		<p>${window.userData.content[1]}</p>
		<button type="button" class="Modal34_btn__s_erE">${window.userData.content[2]}</button>
	</div>
</div>
...
.Modal34_iamgeBg__lXvYX {
	width: 100%;
}

.Modal34_leftDiv__1mAaA {
	position: absolute;
	left: 0;
	margin-top: 2.5rem;
	height: 100%;
...
.Modal34_leftDiv__1mAaA :first-child {
	font-size: 1.875rem;
	line-height: 2.25rem;
}

.Modal34_leftDiv__1mAaA :nth-child(2) {
	margin-top: 1.25rem;
	font-size: 1.125rem;
	line-height: 1.75rem;
}
...
.Modal34_btn__s_erE,.Modal34_cancel__CaNNX {
	border-width: 0;
	outline: 2px solid transparent;
	outline-offset: 2px;
}

.Modal34_cancel__CaNNX {
	position: absolute;
	right: .75rem;
	top: .75rem;
}
