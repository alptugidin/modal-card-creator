...
<div id="MODAL${window.userData.id}" class="Modal2_body__1BWrh" style="--bgColor:${window.userData.color.background};
...
transform:scale(${scale()});transform-origin:${origin()}">
	<button id="cancelButton" type="button" class="Modal2_cancel__3Lm8y">
	...
	<div class="Modal2_topDiv__qGx8F"><img width="480" height="300" src="http://localhost:3000/Modal2/img.png" alt="" /></div>
	<div class="Modal2_bottomDiv__LMfQt">
		...
		<div class="Modal2_btnDiv__zcTD2">
...
.Modal2_bottomDiv__LMfQt,.Modal2_topDiv__qGx8F {
text-align:center;
flex-basis: 50%;
}
.Modal2_topDiv__qGx8F :first-child {
};
.Modal2_textDiv__hHxv4 {
margin-top: 2.5rem;
text-align: center;
color: var(--textColor);
}

.Modal2_textDiv__hHxv4 :first-child {
font-size: 1.875rem;
line-height: 2.25rem;
font-weight: 600;
}

.Modal2_textDiv__hHxv4 :last-child {
margin-top: 1.25rem;
font-size: 1.25rem;
line-height: 1.75rem;
}

.Modal2_btnDiv__zcTD2 {
margin-top: 1.25rem;
display: flex;
flex-direction: column;
align-items: center;
...
.Modal2_btnDiv__zcTD2 :first-child {
height: 3rem;
width: 100%;
border-radius: .5rem;
border-width: 0;
...
.Modal2_btnDiv__zcTD2 :last-child {
height: 3rem;
width: 100%;
border-radius: .5rem;
border-width: 1px;
