...
<svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	<div class="Modal30_body2__zxo7o">
	<img style="border-top-left-radius: .75rem;border-top-right-radius: .75rem" width="400" height="450" src="${window.userData.img.length > 1 ? window.userData.img : 'http://localhost:3000/Modal30/img.png'}" alt="" />
