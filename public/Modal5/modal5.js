...
<div  id="MODAL${window.userData.id}" class="Modal5_body__S87dg" style="--bgColor:${window.userData.color.background};
...
<svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	<div class="Modal5_textDiv__AlZ9L">
		<p>${window.userData.content[0]}</p>
		<p>${window.userData.content[1]}</p>
	</div>
	<div class="Modal5_buttonDiv__W8l2_">
...
.Modal5_textDiv__AlZ9L {
	color: var(--textColor);
}

.Modal5_textDiv__AlZ9L :first-child {
	font-size: 1.875rem;
	line-height: 2.25rem;
	font-weight: 700;
}

.Modal5_textDiv__AlZ9L :last-child {
	margin-top: 1rem;
...
.Modal5_buttonDiv__W8l2_ :first-child {
	height: 3rem;
	width: 100%;
	border-radius: .5rem;
	--tw-text-opacity: 1;
...
.Modal5_buttonDiv__W8l2_ :first-child,.Modal5_cancel__zgf28 {
	border-width: 0;
	outline: 2px solid transparent;
	outline-offset: 2px;
}

.Modal5_cancel__zgf28 {
	position: absolute;
	right: .75rem;
	top: .75rem;
}
