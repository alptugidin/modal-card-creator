...
<div id="MODAL${window.userData.id}" class="Modal19_body__3zLDc" style="--bgColor:${window.userData.color.background};
...
.Modal19_svgDiv__TL27F :first-child {
	fill: var(--themeColor);
}

.Modal19_textDiv__EkF1k {
	margin-top: 1.25rem;
	text-align: center;
	color: var(--textColor);
}

.Modal19_textDiv__EkF1k :first-child {
	font-size: 1.875rem;
	line-height: 2.25rem;
	font-weight: 700;
}

.Modal19_textDiv__EkF1k :last-child {
	margin-top: 1.25rem;
	padding-left: 2.5rem;
...
.Modal19_signDiv__5TCSv :first-child,.Modal19_signDiv__5TCSv :nth-child(2) {
	margin-top: 1.25rem;
	height: 3rem;
	width: 100%;
	border-radius: .5rem;
...
.Modal19_signDiv__5TCSv :last-child {
	margin-top: 1.25rem;
}

.Modal19_cancel__lHQCA {
	position: absolute;
	top: .75rem;
	right: .75rem;
	border-width: 0;
