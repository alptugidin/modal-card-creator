...
<div id="MODAL${window.userData.id}" class="Modal20_body__G6O5r" style="--bgColor:${window.userData.color.background};
...
<svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	<div class="Modal20_svgDiv__z8ApM">
		<svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
			<path d="M30.9 15L31.9 20H45V35H36.6L35.6 30H17.5V15H30.9ZM35 10H12.5V52.5H17.5V35H31.5L32.5 40H50V15H36L35 10Z" fill="#7D4AEA"></path>
		</svg>
	</div>
	<div class="Modal20_textDiv__G9l_w">
	...
	border-width: 1px;
	border-color: #dadada" type="button">
		<div class="Modal20_roundedButton__ukKA5">
			<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
				<path d="M4 11H16.17L10.58 5.41L12 4L20 12L12 20L10.59 18.59L16.17 13H4V11Z" fill="#7D4AEA"></path>
			</svg>
		</div>
	</button>
</div>
...
.Modal20_svgDiv__z8ApM :first-child {
	fill: var(--themeColor);
}

.Modal20_textDiv__G9l_w {
	margin-top: 2.5rem;
	text-align: center;
	color: var(--textColor);
}

.Modal20_textDiv__G9l_w :first-child {
	font-size: 2.25rem;
	line-height: 2.5rem;
	font-weight: 700;
}

.Modal20_textDiv__G9l_w :last-child {
	margin-top: 1.25rem;
	padding-left: 2.5rem;
...
.Modal20_roundedButton__ukKA5 :first-child {
	fill: var(--themeColor);
}

.Modal20_cancel__2fliT {
	position: absolute;
	top: .75rem;
	right: .75rem;
	border-width: 0;
