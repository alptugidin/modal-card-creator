...
<div id="MODAL${window.userData.id}" class="Modal32_body__YJBii" style="--bgColor:${window.userData.color.background};
...
<svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	<div><img src="http://localhost:3000/Modal32/img.png" width="268" height="220" alt="" /></div>
	<div class="Modal32_textDiv__Y15bE" style="--textColor:#000000">
		<p>${window.userData.content[0]}</p>
		<p>${window.userData.content[1]}</p>
	</div>
	<div class="Modal32_btnDiv__Y4UXj" style="--borderColor:#DDDDDD">
...
.Modal32_textDiv__Y15bE {
	margin-top: 1.25rem;
	text-align: center;
	color: var(--textColor);
}

.Modal32_textDiv__Y15bE :first-child {
	font-size: 2.25rem;
	line-height: 2.5rem;
	font-weight: 700;
}

.Modal32_textDiv__Y15bE :nth-child(2) {
	margin-top: 1.25rem;
	font-size: 1.25rem;
	line-height: 1.75rem;
}

.Modal32_btnDiv__Y4UXj {
	margin-top: 2.5rem;
	display: flex;
	width: 100%;
}

.Modal32_btnDiv__Y4UXj :first-child {
	height: 3rem;
	width: 100%;
	border-radius: .5rem;
	border-width: 1px;
