...
<div  id="MODAL${window.userData.id}"  class="Modal11_body__AVu0Y" style="--bgColor:${window.userData.color.background};
...
<svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	<div class="Modal11_inputDiv__fBMOC">
		<input style="width: 94%" type="text" placeholder="${window.userData.content[2]}" />
	</div>
	<div class="Modal11_signDiv__f4gsI">
		<button type="button">${window.userData.content[3]}</button>
	</div>
	<div class="Modal11_accountText__uKNGm">
...
.Modal11_imgDiv__uSosx :first-child {
	margin-left: auto;
	margin-right: auto;
}

.Modal11_textDiv__cl_5c {
	text-align: center;
	color: var(--textColor);
}

.Modal11_textDiv__cl_5c :first-child {
	font-size: 1.875rem;
	line-height: 2.25rem;
	font-weight: 700;
}

.Modal11_textDiv__cl_5c :last-child {
	margin-top: 1.25rem;
	font-size: 1.25rem;
	line-height: 1.75rem;
}

.Modal11_inputDiv__fBMOC {
	margin-top: 1.25rem;
	display: flex;
	width: 100%;
	flex-direction: column;
...
.Modal11_inputDiv__fBMOC :first-child {
	height: 3rem;
	width: 100%;
	gap: 1.25rem;
	border-radius: .5rem;
...
.Modal11_inputDiv__fBMOC :first-child::-moz-placeholder {
	--tw-placeholder-opacity: 1;
	color: rgb(75 85 99/var(--tw-placeholder-opacity));
}

.Modal11_inputDiv__fBMOC :first-child::placeholder {
	--tw-placeholder-opacity: 1;
	color: rgb(75 85 99/var(--tw-placeholder-opacity));
}
...
.Modal11_signDiv__f4gsI :first-child {
	margin-top: 1.25rem;
	height: 3rem;
	width: 100%;
	border-radius: .5rem;
...
.Modal11_accountText__uKNGm span {
