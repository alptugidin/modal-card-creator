...
window.onload = () => {
  ...
  const raw = `
  <div  id="MODAL${window.userData.id}" class="Modal3_body__k8yqy"
  style="--bgColor:${window.userData.color.background};
...
<button id="cancelButton" type="button" class="cancelClass">
...
<div class="Modal3_textDiv__7bAIh">
<p>${window.userData.content[0]}</p>
<p>${window.userData.content[1]}</p>
<p>${window.userData.content[2]}</p>
</div>
<div class="Modal3_optionDiv__Kptvw">
<div class="Modal3_option__cyuYm">
<button type="button" data-plan="Cancel" class="Modal3_optionRound__1BVID"></button>
<div class="Modal3_optionTextDiv__Z93xB">
<p>${window.userData.content[3]}</p>
<p>${window.userData.content[4]}</p>
</div>
</div>
<div class="Modal3_option__cyuYm">
<button type="button" class="Modal3_optionRound__1BVID"></button>
<div class="Modal3_optionTextDiv__Z93xB">
<p>${window.userData.content[5]}</p>
<p>${window.userData.content[6]}</p>
</div>
</div>
<div class="Modal3_option__cyuYm">
<button type="button" class="Modal3_optionRound__1BVID"></button>
<div class="Modal3_optionTextDiv__Z93xB">
<p>${window.userData.content[7]}</p>
<p>${window.userData.content[8]}</p>
</div>
</div>
</div>
<div class="Modal3_btnDiv__aLEDJ">
<button type="button">${window.userData.content[9]}</button>
<button type="button">${window.userData.content[10]}</button>
</div>
</div>
`;
...
.Modal3_textDiv__7bAIh :first-child {
color: var(--themeColor);
}

.Modal3_textDiv__7bAIh :nth-child(2) {
font-size: 1.875rem;
line-height: 2.25rem;
font-weight: 600;
}

.Modal3_textDiv__7bAIh :last-child {
font-size: 1.25rem;
line-height: 1.75rem;
}

.Modal3_textDiv__7bAIh :last-child,.Modal3_textDiv__7bAIh :nth-child(2) {
color: var(--textColor);
}

.Modal3_optionDiv__Kptvw {
margin-top: 2.5rem;
display: flex;
flex-direction: column;
//gap: 2.5rem;
...
.Modal3_optionRound__1BVID:hover {
outline-style: solid;
outline-width: 2px;
outline-color: var(--themeColor);
}

.Modal3_option__cyuYm {
display: flex;
gap: 1.25rem;
}

.Modal3_optionTextDiv__Z93xB :first-child {
color: var(--textColor);
}

.Modal3_optionTextDiv__Z93xB :last-child {
margin-top: .25rem;
font-size: .75rem;
line-height: 1rem;
...
.Modal3_btnDiv__aLEDJ :first-child,.Modal3_btnDiv__aLEDJ :last-child {
height: 3rem;
width: 100%;
border-radius: .5rem;
border-width: 1px;
...
.Modal3_btnDiv__aLEDJ :last-child {
border-width: 0;
--tw-text-opacity: 1;
