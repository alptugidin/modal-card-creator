...
<div id="MODAL${window.userData.id}"  class="Modal33_body__Sgw35" style="--bgColor:${window.userData.color.background};
...
<svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	<div class="Modal33_divLeft___qKIH">
		<div>
		<img style="border-top-right-radius: .75rem;border-top-left-radius: .75rem" width="370" height="400" src="${window.userData.img.length > 1 ? window.userData.img : 'https://modal-card-creator-eight.vercel.app/Modal33/img.png'}" alt="img " />
		</div>
	</div>
	<div class="Modal33_divRight__iXZ49">
		...
		<div class="Modal33_foot__NankL" style="--borderColor:#DDDDDD;--bgColor:#7D4AEA">
...
.Modal33_divLeft___qKIH {
	flex-basis: 50%;
}

.Modal33_divRight__iXZ49 {
	flex-basis: 50%;
	padding: 2.5rem;
}

.Modal33_textDiv__jEwXT {
	text-align: center;
	color: var(--textColor);
}

.Modal33_textDiv__jEwXT :first-child {
	font-size: 2.25rem;
	line-height: 2.5rem;
	font-weight: 700;
}

.Modal33_textDiv__jEwXT :nth-child(2) {
	margin-top: 2rem;
	font-size: 1.25rem;
	line-height: 1.75rem;
}
...
.Modal33_foot__NankL :first-child {
	height: 3rem;
	width: 97%;
	border-radius: .5rem;
	border-width: 1px;
...
.Modal33_foot__NankL :first-child::-moz-placeholder {
	--tw-placeholder-opacity: 1;
	color: rgb(75 85 99/var(--tw-placeholder-opacity));
}

.Modal33_foot__NankL :first-child::placeholder {
	--tw-placeholder-opacity: 1;
	color: rgb(75 85 99/var(--tw-placeholder-opacity));
}
...
.Modal33_foot__NankL :nth-child(2) {
	height: 3rem;
	width: 100%;
	border-radius: .5rem;
	--tw-text-opacity: 1;
