...
<div id="MODAL${window.userData.id}" class="Modal29_body__LrFha" style="--bgColor:${window.userData.color.background};
...
<svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	<div class="Modal29_rightDiv__QR4CZ" style="--textColor:#000000">
		...
		<div class="Modal29_foot__V_HJR" style="--borderColor:#DDDDDD;--btnColor:#7D4AEA">
...
.Modal29_leftDiv__XM8Xm {
	flex-basis: 40%;
	overflow: hidden;
	border-radius: .5rem;
}

.Modal29_leftDiv__XM8Xm :first-child {
	height: 100%;
	width: 100%;
}

.Modal29_rightDiv__QR4CZ {
	flex-basis: 60%;
	padding: 1.25rem 2.5rem;
	color: var(--textColor);
}

.Modal29_rightDiv__QR4CZ :first-child {
	font-size: 3.75rem;
	line-height: 1;
	font-weight: 600;
}

.Modal29_rightDiv__QR4CZ :nth-child(2) {
	margin-top: 1.25rem;
	font-size: 1.25rem;
	line-height: 1.75rem;
}
...
.Modal29_foot__V_HJR :first-child {
	margin-top: 2.25rem;
	height: 3rem;
...
.Modal29_foot__V_HJR :first-child::-moz-placeholder {
	--tw-placeholder-opacity: 1;
	color: rgb(75 85 99/var(--tw-placeholder-opacity));
}

.Modal29_foot__V_HJR :first-child::placeholder {
	--tw-placeholder-opacity: 1;
	color: rgb(75 85 99/var(--tw-placeholder-opacity));
}
...
.Modal29_foot__V_HJR :nth-child(2) {
	height: 3rem;
	width: 100%;
	border-radius: .5rem;
	border-width: 0;
