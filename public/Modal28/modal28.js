...
<div id="MODAL${window.userData.id}" class="Modal28_body__vFbnK" style="--bgColor:${window.userData.color.background};
...
<svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	<div class="Modal28_textDiv__2gduD" style="--textColor:#000000">
		<p>${window.userData.content[2]}</p>
		<p>${window.userData.content[3]}</p>
	</div>
	<div class="Modal28_footer__dohZs" style="--borderColor:#DDDDDD;--bgColor:#7D4AEA">
		<input style="margin-top: 40px" type="text" placeholder="${window.userData.content[4]}" />
		<button style="margin-top: 10px" type="button">${window.userData.content[5]}</button>
	</div>
</div>
...
.Modal28_ppDiv__N5gVm {
	display: flex;
}

.Modal28_infoDiv___7EMl {
	margin-left: 1.25rem;
	display: flex;
...
.Modal28_infoDiv___7EMl :first-child {
	font-size: 1.25rem;
	line-height: 1.75rem;
	font-weight: 600;
}

.Modal28_infoDiv___7EMl :nth-child(2) {
	font-size: .875rem;
	line-height: 1.25rem;
}

.Modal28_textDiv__2gduD {
	color: var(--textColor);
	margin-top: 2.5rem;
}

.Modal28_textDiv__2gduD :first-child {
	font-size: 2.25rem;
	line-height: 2.5rem;
	font-weight: 700;
}

.Modal28_textDiv__2gduD :nth-child(2) {
	margin-top: 1.25rem;
	font-size: 1.5rem;
	line-height: 2rem;
}

.Modal28_footer__dohZs {
	margin-top: 1.25rem;
	display: flex;
	flex-direction: column;
	gap: 1.25rem;
...
.Modal28_footer__dohZs :first-child {
...
.Modal28_footer__dohZs :first-child::-moz-placeholder {
	--tw-placeholder-opacity: 1;
	color: rgb(75 85 99/var(--tw-placeholder-opacity));
}

.Modal28_footer__dohZs :first-child::placeholder {
	--tw-placeholder-opacity: 1;
	color: rgb(75 85 99/var(--tw-placeholder-opacity));
}

.Modal28_footer__dohZs :nth-child(2) {
	background-color: var(--bgColor);
	height: 3rem;
	width: 100%;
	border-radius: .5rem;
