...
window.onload = () => {
  ...
  const raw = `<div id="MODAL${window.userData.id}" class="Modal16_body__9XyDO" style="--bgColor:${window.userData.color.background};
...
<svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	<div class="Modal16_svgDiv__7e_ZS">
	...
	<div class="Modal16_textDiv__0RlZg">
		<p>${window.userData.content[0]}🥳</p>
		<p>${window.userData.content[1]}</p>
	</div>
	<div class="Modal16_signDiv__Bpm_u">
...
.Modal16_svgDiv__7e_ZS :first-child {
	fill: var(--themeColor);
}

.Modal16_textDiv__0RlZg {
	margin-top: 2.5rem;
	text-align: center;
	color: var(--textColor);
}

.Modal16_textDiv__0RlZg :first-child {
	font-size: 3rem;
	line-height: 1;
	font-weight: 700;
}

.Modal16_textDiv__0RlZg :last-child {
	margin-top: 1.25rem;
	padding-left: 2.5rem;
...
.Modal16_signDiv__Bpm_u :first-child {
	margin-top: 1.25rem;
	height: 3rem;
	width: 100%;
	border-radius: .5rem;
