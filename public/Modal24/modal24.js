...
<div id="MODAL${window.userData.id}"  class="Modal24_modal__2Xk07 " style="--bgColor:${window.userData.color.background};
...
transform:scale(${scale()});transform-origin:${origin()}">
	<div id="MODAL${window.userData.id}" class="Modal24_head___uoNi">
...
<svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path opacity="0.4" d="M18 3.00001C15.0333 3.00001 12.1332 3.87974 9.66645 5.52796C7.19972 7.17618 5.27713 9.51886 4.14181 12.2598C3.0065 15.0006 2.70945 18.0166 3.28823 20.9264C3.86701 23.8361 5.29562 26.5088 7.3934 28.6066C9.49119 30.7044 12.1639 32.133 15.0737 32.7118C17.9834 33.2906 20.9994 32.9935 23.7403 31.8582C26.4811 30.7229 28.8238 28.8003 30.472 26.3336C32.1203 23.8668 33 20.9667 33 18C33.0018 16.0297 32.6151 14.0783 31.8619 12.2576C31.1088 10.4369 30.004 8.78254 28.6107 7.3893C27.2175 5.99605 25.5632 4.89123 23.7424 4.13806C21.9217 3.38489 19.9704 2.99816 18 3.00001ZM18 30C15.6266 30 13.3066 29.2962 11.3332 27.9776C9.35977 26.6591 7.8217 24.7849 6.91345 22.5922C6.0052 20.3995 5.76756 17.9867 6.23058 15.6589C6.69361 13.3312 7.8365 11.193 9.51473 9.51473C11.193 7.8365 13.3312 6.69361 15.6589 6.23058C17.9867 5.76756 20.3995 6.0052 22.5922 6.91345C24.7849 7.8217 26.6591 9.35977 27.9776 11.3332C29.2962 13.3066 30 15.6266 30 18C29.9958 21.1813 28.7301 24.2311 26.4806 26.4806C24.2311 28.7301 21.1813 29.9958 18 30ZM23.385 10.5L18 15.885L12.615 10.5L10.5 12.615L15.885 18L10.5 23.385L12.615 25.5L18 20.115L23.385 25.5L25.5 23.385L20.115 18L25.5 12.615L23.385 10.5Z" fill="black"/>
		...
		<svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
			<path d="M30 60C46.5685 60 60 46.5685 60 30C60 13.4315 46.5685 0 30 0C13.4315 0 0 13.4315 0 30C0 46.5685 13.4315 60 30 60Z" fill="#7D4AEA"></path>
			<path d="M26.276 37.762V35.15L32.733 32.509V36.717C32.733 38.517 33.398 39.423 35.346 39.423C36.3504 39.3847 37.3429 39.1924 38.289 38.853L39 44.645C37.2932 45.2447 35.4928 45.5343 33.684 45.5C28.46 45.5 26.276 42.034 26.276 37.762ZM21 27.647L26.276 25.489V14.5H32.733V22.848L38.01 20.689V26.876L21 33.835V27.647Z" fill="white"></path>
		</svg>
		<p class="Modal24_text1__Vc_Pr" style="--c:#7D4AEA">${window.userData.content[0]}</p>
	</div>
	<div class="Modal24_body__Vgh9e">
		<p class="Modal24_text2__N7ddf" style="--c:#000000">${window.userData.content[1]}</p>
		<p class="Modal24_text3__yoJgh" style="--c:#000000">${window.userData.content[2]}</p>
	</div>
	<div class="Modal24_foot__Sbj2c">
		<button type="button" style="--c:#7D4AEA">${window.userData.content[3]}</button>
...
.Modal24_body__Vgh9e :first-child {
	font-size: 1.875rem;
	line-height: 2.25rem;
	font-weight: 700;
}

.Modal24_text1__Vc_Pr {
	color: var(--c);
	font-size: 2.25rem;
	line-height: 2.5rem;
	font-weight: 600;
...
.Modal24_text2__N7ddf,.Modal24_text3__yoJgh {
	color: var(--c);
	margin-top: 1.25rem;
}

.Modal24_text3__yoJgh {
	font-size: 1.25rem;
	line-height: 1.75rem;
}
...
.Modal24_foot__Sbj2c :first-child {
	background-color: var(--c);
	--tw-text-opacity: 1;
	color: rgb(255 255 255/var(--tw-text-opacity));
}

.Modal24_foot__Sbj2c button {
	height: 3rem;
	width: 100%;
	border-radius: .5rem;
}
